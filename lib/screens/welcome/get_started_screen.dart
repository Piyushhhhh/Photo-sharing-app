...
import 'package:piyushPhotoSharing/screens/welcome/local_widget/app_logo.dart';
import 'package:piyushPhotoSharing/widgets/blue_button.dart';
import 'package:piyushPhotoSharing/widgets/background_image.dart';
...
class GetStartedPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          //image background for piyushPhotoSharing get started screen
          ImageCover(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                //app logo for piyushPhotoSharing
                //title for piyushPhotoSharing
